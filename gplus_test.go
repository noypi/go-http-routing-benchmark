...
// Static
func BenchmarkNoypi_GPlusStatic(b *testing.B) {
	req, _ := http.NewRequest("GET", "/people", nil)
	benchRequest(b, gplusNoypi, req)
}
...
// One Param
func BenchmarkNoypi_GPlusParam(b *testing.B) {
...
// Two Params
func BenchmarkNoypi_GPlus2Params(b *testing.B) {
...
// All Routes
func BenchmarkNoypi_GPlusAll(b *testing.B) {
	benchRoutes(b, gplusNoypi, gplusAPI)
}
